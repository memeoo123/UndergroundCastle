...
var MONSTER_CONFIG_EXTERNAL = {
    monsters: {
        ...
        bat: {
            name: '蝙蝠',
            tier: 1,
            stats: { hp: 320, attack: 54, defense: 20, speed: 12 },
            skills: ['basic_attack'],
        ...
        rat: {
            name: '巨鼠',
            tier: 1,
            stats: { hp: 320, attack: 54, defense: 20, speed: 9 },
            skills: ['basic_attack'],
        ...
        ghost: {
            name: '幽灵',
            tier: 2,
            stats: { hp: 1336, attack: 89, defense: 33, speed: 12 },
            skills: ['basic_attack'],
        ...
        spider: {
            name: '巨蛛',
            tier: 2,
            stats: { hp: 1336, attack: 89, defense: 33, speed: 10 },
            skills: ['basic_attack'],
        ...
        mushroom: {
            name: '毒蘑菇',
            tier: 3,
            stats: { hp: 3560, attack: 187, defense: 56, speed: 8 },
            skills: ['basic_attack'],
        ...
        fire_imp: {
            name: '火焰小鬼',
            tier: 4,
            stats: { hp: 8152, attack: 376, defense: 93, speed: 11 },
            skills: ['basic_attack'],
        ...
        lava_hound: {
            name: '熔岩犬',
            tier: 4,
            stats: { hp: 8152, attack: 376, defense: 93, speed: 9 },
            skills: ['basic_attack', 'power_strike'],
        ...
        frost_elemental: {
            name: '冰霜元素',
            tier: 5,
            stats: { hp: 17360, attack: 736, defense: 155, speed: 10 },
            skills: ['basic_attack'],
        ...
        ice_wraith: {
            name: '冰魂',
            tier: 5,
            stats: { hp: 17360, attack: 736, defense: 155, speed: 12 },
            skills: ['basic_attack'],
        ...
        ancient_spirit: {
            name: '远古亡灵',
            tier: 6,
            stats: { hp: 35136, attack: 1408, defense: 258, speed: 10 },
            skills: ['basic_attack'],
        ...
        poison_drake: {
            name: '毒龙',
            tier: 7,
            stats: { hp: 58616, attack: 2349, defense: 431, speed: 11 },
            skills: ['basic_attack'],
        ...
        void_shade: {
            name: '虚空暗影',
            tier: 8,
            stats: { hp: 97736, attack: 3917, defense: 719, speed: 12 },
            skills: ['basic_attack'],
        ...
        rift_stalker: {
            name: '裂隙猎手',
            tier: 8,
            stats: { hp: 97736, attack: 3917, defense: 719, speed: 10 },
            skills: ['basic_attack', 'power_strike'],
